      ...
      <section className="event-section fix section-padding section-bg pb-0">
            <div className="container">
                                    ...
                                    <div className="accordion-btn">
                                        <div className="content-items">
                                            ...
                                            <div className="content">
                                                <h5><Link to="/event-details">{item.title}</Link></h5>
                                            </div>
                                        </div>
                                        ...
                                        <ul className="button-list">
                                            ...
                                            <li>
                                                <Link to="/event-details" className="theme-btn">View Events</Link>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                ...
                <div className="event-button text-center mt-5 wow fadeInUp" data-wow-delay=".3s">
                    <Link to="/event" className="theme-btn yellow-btn">View All Events</Link>
                </div>
            </div>
